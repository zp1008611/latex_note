...
\input{./chapter/preliminary_knowledge.tex}
%%%%%%%%%%%%%preface end%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%part1%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Convexity and Unconstrained Optimization}

\input{./chapter/unconstrained_optimization_and_optimality_conditions.tex}
\input{./chapter/convexity.tex}


\input{chapter/descent_algorithms.tex}
\input{chapter/gradient_desent.tex}
\input{chapter/line_search.tex}
\input{chapter/newton.tex}
\input{chapter/conjugate_direction.tex}
\input{chapter/quasi-newton.tex}
\input{chapter/trust_region.tex}
\input{chapter/nonlinear_least_squares.tex}
