...
\title{\bf \huge Study Notes of Mathematical Statistics}
...
\input{chapter/5_Consistency_and_Limiting_Distributions.tex}
\input{chapter/6_maximum_likelihood_methods.tex}
\input{chapter/7_sufficiency.tex}
