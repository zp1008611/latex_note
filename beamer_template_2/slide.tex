...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[keepaspectratio, scale=0.18]{pic/scnulogo.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
This template is a based on \href{https://www.overleaf.com/latex/templates/thu-beamer-theme/vwnqmzndvwyb}{\textcolor{blue}{THU Beamer Theme}} from Jiayi Weng.
